...
/**
 * RmaConfirmReturnApproveItemsRequestItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RmaConfirmReturnApproveItemsRequestItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'rmaConfirmReturnApproveItemsRequestItem';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['grn'] === null) {
            $invalidProperties[] = "'grn' can't be null";
        }
